...
WELCOME_TEXT = (
    ...
    "<b>Plotina bot</b> в целях функционирования бота: управления расписанием, "
    "уведомлений, аналитики и улучшения сервиса.\n\n"
...
RESET_CONSENT_TEXT = (
    ...
    "бота <b>Plotina bot</b> в целях функционирования бота: управления расписанием, "
    "уведомлений, аналитики и улучшения сервиса.\n\n"
    "Данные не передаются третьим лицам."
)
